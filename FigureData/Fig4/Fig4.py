...
# DFT relaxed band
bd=np.load(f'DFT_relaxed_band_{ms1}.npy')
bandtar_ms1=np.zeros((nbnd_fit,num_kpt_band))
for i in range(nbnd_fit):
    bandtar_ms1[i,:]=bd[:,i]

bd=np.load(f'DFT_relaxed_band_{ms2}.npy')
bandtar_ms2=np.zeros((nbnd_fit,num_kpt_band))
for i in range(nbnd_fit):
    bandtar_ms2[i,:]=bd[:,i]

bd=np.load(f'DFT_relaxed_band_{ms3}.npy')
bandtar_ms3=np.zeros((nbnd_fit,num_kpt_band))
for i in range(nbnd_fit):
    bandtar_ms3[i,:]=bd[:,i]

# DFT unrelax band
bd=np.load(f'DFT_unrelax_band_{ms1}.npy')
bandtar_ms1_us=np.zeros((nbnd_fit,num_kpt_band))
for i in range(nbnd_fit):
    bandtar_ms1_us[i,:]=bd[:,i]

bd=np.load(f'DFT_unrelax_band_{ms2}.npy')
bandtar_ms2_us=np.zeros((nbnd_fit,num_kpt_band))
for i in range(nbnd_fit):
    bandtar_ms2_us[i,:]=bd[:,i]

bd=np.load(f'DFT_unrelax_band_{ms3}.npy')
bandtar_ms3_us=np.zeros((nbnd_fit,num_kpt_band))
for i in range(nbnd_fit):
    bandtar_ms3_us[i,:]=bd[:,i]

# DFT relaxed charge line
ldos_ref_ms1=np.load(f'DFT_relaxed_charge_line_{ms1}.npy')
ldos_ref_ms2=np.load(f'DFT_relaxed_charge_line_{ms2}.npy')
ldos_ref_ms3=np.load(f'DFT_relaxed_charge_line_{ms3}.npy')

# DFT unrelax charge line
ldos_ref_ms1_us=np.load(f'DFT_unrelax_charge_line_{ms1}.npy')
ldos_ref_ms2_us=np.load(f'DFT_unrelax_charge_line_{ms2}.npy')
ldos_ref_ms3_us=np.load(f'DFT_unrelax_charge_line_{ms3}.npy')


# Model relaxed band
ek_ms1=np.load(f'Model_relaxed_band_{ms1}.npy')
ek_ms2=np.load(f'Model_relaxed_band_{ms2}.npy')
ek_ms3=np.load(f'Model_relaxed_band_{ms3}.npy')

# Model unrelax band
ek_ms1_un=np.load(f'Model_unrelax_band_{ms1}.npy')
ek_ms2_un=np.load(f'Model_unrelax_band_{ms2}.npy')
ek_ms3_un=np.load(f'Model_unrelax_band_{ms3}.npy')

# Model relaxed charge
ldos_ms1=np.load(f'Model_relaxed_charge_{ms1}.npy')
ldos_ms2=np.load(f'Model_relaxed_charge_{ms2}.npy')
ldos_ms3=np.load(f'Model_relaxed_charge_{ms3}.npy')

# Model unrelax charge
ldos_ms1_un=np.load(f'Model_unrelax_charge_{ms1}.npy')
ldos_ms2_un=np.load(f'Model_unrelax_charge_{ms2}.npy')
ldos_ms3_un=np.load(f'Model_unrelax_charge_{ms3}.npy')

# Model relaxed charge line
ldos_line_ms1=np.load(f'Model_relaxed_charge_line_{ms1}.npy')
ldos_line_ms2=np.load(f'Model_relaxed_charge_line_{ms2}.npy')
ldos_line_ms3=np.load(f'Model_relaxed_charge_line_{ms3}.npy')

# Model unrelax charge line
ldos_line_ms1_un=np.load(f'Model_unrelax_charge_line_{ms1}.npy')
ldos_line_ms2_un=np.load(f'Model_unrelax_charge_line_{ms2}.npy')
ldos_line_ms3_un=np.load(f'Model_unrelax_charge_line_{ms3}.npy')
...
Ls_ms1 = np.sqrt(3 * ms1**2 + 3 * ms1 + 1) * alat
kline_ms1,klen_ms1,avec_ms1,rc_ms1=la_ve(Ls_ms1)

Ls_ms2 = np.sqrt(3 * ms2**2 + 3 * ms2 + 1) * alat
kline_ms2,klen_ms2,avec_ms2,rc_ms2=la_ve(Ls_ms2)

Ls_ms3 = np.sqrt(3 * ms3**2 + 3 * ms3 + 1) * alat
kline_ms3,klen_ms3,avec_ms3,rc_ms3=la_ve(Ls_ms3)
...
plot_band(ms1, klen_ms1, ek_ms1_un, kline_ms1, bandtar_ms1_us, 0)
plot_band(ms2, klen_ms2, ek_ms2_un, kline_ms2, bandtar_ms2_us, 0)
plot_band(ms3, klen_ms3, ek_ms3_un, kline_ms3, bandtar_ms3_us, 0)

plot_band(ms1, klen_ms1, ek_ms1, kline_ms1, bandtar_ms1, 1)
plot_band(ms2, klen_ms2, ek_ms2, kline_ms2, bandtar_ms2, 1)
plot_band(ms3, klen_ms3, ek_ms3, kline_ms3, bandtar_ms3, 1)
...
plot_chgden(ms1, ldos_ms1_un, avec_ms1, rc_ms1, 0)
plot_chgden(ms2, ldos_ms2_un, avec_ms2, rc_ms2, 0)
plot_chgden(ms3, ldos_ms3_un, avec_ms3, rc_ms3, 0)

plot_chgden(ms1, ldos_ms1, avec_ms1, rc_ms1, 1)
plot_chgden(ms2, ldos_ms2, avec_ms2, rc_ms2, 1)
plot_chgden(ms3, ldos_ms3, avec_ms3, rc_ms3, 1)
...
plot_chgden_line(ms1, ldos_line_ms1_un, ldos_ref_ms1_us, 0)
plot_chgden_line(ms2, ldos_line_ms2_un, ldos_ref_ms2_us, 0)
plot_chgden_line(ms3, ldos_line_ms3_un, ldos_ref_ms3_us, 0)

plot_chgden_line(ms1, ldos_line_ms1, ldos_ref_ms1, 1)
plot_chgden_line(ms2, ldos_line_ms2, ldos_ref_ms2, 1)
plot_chgden_line(ms3, ldos_line_ms3, ldos_ref_ms3, 1)
